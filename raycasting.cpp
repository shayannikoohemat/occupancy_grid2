...
/*    for (int m = 0; m<points.size(); m++)
    ...
    for (segment_number = segment_numbers.begin(); segment_number != segment_numbers.end(); segment_number++){
        ...
        /// build KD-tree for segment points
...
/*            laser2ascii_cpp( args->String("D:\\test\\raycasting\\matched_trajectories.laser"),
                             args->Contains("-x"), args->Contains("-y"),
                            args->Contains("-z"), args->Contains("-t"),
                             args->String("D:\\test\\raycasting\\matched_trajectories.asc"));*/
        }
